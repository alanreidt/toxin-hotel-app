...
<style lang="less">
  ...
  @import (inline) "../../node_modules/jquery-ui/themes/base/datepicker.css";
  ...
  .ui-datepicker {
    ...
    &-prev .ui-icon {
      .decoration_type_arrow-back(24px, 24px, 0);
    }

    &-next .ui-icon {
      .decoration_type_arrow-forward(24px, 24px, 0);
    }
